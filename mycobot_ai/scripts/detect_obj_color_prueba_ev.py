...
class Object_detect(Movement):
    ...
    def __init__(self, camera_x=150, camera_y=-10):
        ...
        # 移动角度
        self.move_angles = [
            [0, -6.94, -55.01, -24.16, 0, 0],  # init the point
    ...
    def move(self, x, y, color):
        ...
        time.sleep(1.5)
        # open pump
        self.pub_pump(True,[20,21]) # era self.gpio_status(True)
        time.sleep(0.5)
        self.pub_angles(self.move_angles[2], 20)
        time.sleep(3)
        self.pub_marker(
        ...
        time.sleep(2)
        # close pump
        self.pub_pump(False,[20,21]) # era self.gpio_status(False)
        if color == 1:
            self.pub_marker(
    ...
    def run(self):
        ...
        for _ in range(5):
            self.pub_angles([0, -6.94, -55.01, -24.16, 0, 0], 20)
            print(_)
            time.sleep(0.5)
        self.pub_pump(False,[20,21]) # era self.gpio_status(False)
