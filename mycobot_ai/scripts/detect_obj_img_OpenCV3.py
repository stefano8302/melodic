...
class Object_detect(Movement):
    def __init__(self, camera_x=150, camera_y=-10):
	    ...
	    # 移动角度
        self.net = load_model('cat_dog_100epochs.h5')
    ...
    def obj_detect(self, frame, goal):
        ...
        i = 0
        MIN_MATCH_COUNT = 10
        sift = cv2.xfeatures2d.SIFT_create() # it was  sift = cv2.SIFT_create()
...
def run():
    ...
    while cv2.waitKey(1) < 0:
       # read camera
        ...
        ## Si quitamos esta parte abajo, no se recorta la imagen (lineas 323 -> 346)
        #if init_num < 20:
