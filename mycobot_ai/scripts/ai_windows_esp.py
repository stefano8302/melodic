...
class Application(object):
    def __init__(self):
        ...
        self.myComboList = [
                            ...
                            u"Evitar Obstaculos", u"Moveit Commander Command Line"
                            ]
        ...
        self.myComboList2 = [u"RViz Deslizadores Pinza Fija", u"RViz Deslizadores Pinza Movil", u"RViz MoveIt Pinza Fija", u"RViz MoveIt Apagado Pinza Fija",
                             u"RViz MoveIt Pinza Movil", u"RViz Verter Cerveza", u"RViz Evitar Obstaculo", u"RViz+Gazebo 2 Robots y cinta",
                             u"RViz Visión Artificial Moveit"]
    ...
    def open_py(self):
        os.system(
            ...
            "python ~/catkin_ws/src/mycobot_ros/mycobot_ai/scripts/detect_obj_img_pinza.py"
        )

    def open_py1(self):
        os.system(
            #"python ~/catkin_ws/src/mycobot_ros/mycobot_ai/scripts/detect_obj_color.py"
            "python ~/catkin_ws/src/mycobot_ros/mycobot_ai/scripts/detect_obj_color_pinza.py"
        )
    def python_py1_moveit(self):
        os.system(
            "python ~/catkin_ws/src/mycobot_ros/mycobot_ai/scripts/detect_obj_color_pinza_moveit.py"
        )
    def open_py2(self):
        os.system(
    ...
    def open_pysuction(self):
        os.system(
            "python ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/scripts/mycobot320_legrip_pi_pl.py"
        )

    def python_moveitcommander(self):
        os.system(
            "python ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/scripts/mycobot320_legrip_pi_pl2.py"
        )

    def python_avoid(self):
        os.system(
            "python ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/scripts/mycobot320_avoid.py"
        )
    ...
    def python_writing(self):
        os.system(
            "python ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/scripts/mycobot320_writing.py"
        )
    ...
    #    os.system(
    #        "python ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/scripts/mycobot320_pick_place.py"
    #    )

    #def lite6_python_writing(self):
    #    os.system(
    #        "python ~/catkin_ws/src/xarm_ros/lite6_moveit_config/scripts/lite6_writing.py"
    #    )
    ...
    def vis_art(self):
        os.system(
            ...
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_ai/launch/vision_320.launch"
        )

    def vis_art_moveit(self):
        os.system(
            #"roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_ai/launch/vision.launch"
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/launch/demo_vision_moveit_apagado.launch"
        )

    def rviz_desliza_fija(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320/launch/mycobot_320_slider.launch"
        )
    
    def rviz_desliza_movil(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320/launch/mycobot_320_slider_gripper.launch"
        )
    
    def rviz_moveit_fija(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/launch/demo.launch"
        )
    def rviz_moveit_apagado_fija(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/launch/demo_moveit_apagado.launch"
        )
    def rviz_moveit_movil(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/launch/demo_pinza.launch"
        )
    #def lite6_rviz_moveit_fija(self):
    #    os.system(
    #        "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo.launch"
    #    )
            
    def simu_cerveza(self):
        os.system(
            "roslaunch ~/catkin_ws/src/mycobot_ros/mycobot_320_moveit/launch/demo_pouring.launch"
        )
    ...
    #    os.system(
    #        "roslaunch ~/catkin_ws/src/myCobotROS/mycobot_320_moveit_pi_pl/launch/demo_gazebo_suctiongrip.launch"
    #    )
