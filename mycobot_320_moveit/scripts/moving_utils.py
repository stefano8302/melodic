...
from mycobot_communication.msg import MycobotSetAngles, MycobotSetCoords, MycobotPumpStatus, MycobotGripperStatus # MycobotGripperStatus anadido por Stefano
