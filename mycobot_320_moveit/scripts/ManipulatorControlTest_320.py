...
import time
import rospy
import moveit_commander # added
import moveit_msgs.msg # added
import geometry_msgs.msg # added
...
class OpenManipulatorMove(object):
    def __init__(self):
        ...
        self.goal_dynamixel_position_publisher = rospy.Publisher('move_group/fake_controller_joint_states',
                                                                    JointState,
                                                                    queue_size=1)
    ...
    def move_all_joints(self, position_array):
        ...
        if len(position_array) == number_of_joints:
            if self.check_gripper_pos_safe(position_array[5]):
                ...
                rospy.logerr("Gripper position NOT valid=" + str(position_array[5]))
        else:
    ...
    def check_gripper_pos_safe(self, gripper_value):
        """
        We need to check that the gripper pos is 3.14 > position[5] > -3.14
        Otherwise it gets jammed
        :param gripper_value:
        :return:
        """
        return (3.14 > gripper_value > -3.14)
...
def movement_sequence_test():
    ...
    joint_position_home = [0.08743690699338913, 1.0385050773620605, -2.345456600189209, -0.016873789951205254,
                           -1.4818254709243774, 0.0015339808305725455]
